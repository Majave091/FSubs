...
BOT_TOKEN = environ.get("BOT_TOKEN", "6773197545:AAFGvtigWcJueMhY-KlOpIDjJ1e6N-JEpZY")

CHANNEL_DB = int(environ.get("CHANNEL_DB", "-1002108529795"))
DATABASE_URL = environ.get("DATABASE_URL", "mongodb+srv://userbot:userbot1@akimov.uknvehq.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get("DATABASE_NAME", "Akimov")
...
try:
    ADMINS = [int(x) for x in (environ.get("ADMINS", "6934063546").split())]
except ValueError:
